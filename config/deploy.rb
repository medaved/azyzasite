...
# Default deploy_to directory is /mnt/temp/www/my_app_name
# set :deploy_to, '/mnt/temp/www/my_app_name'
...
namespace :deploy do
  ...
  task :setup do
    ...
    #  execute "mkdir  #{shared_path}/config/"
     # execute "mkdir  /mnt/temp/www/apps/#{application}/run/"
      #execute "mkdir  /mnt/temp/www/apps/#{application}/log/"
      #execute "mkdir  /mnt/temp/www/apps/#{application}/socket/"
      #execute "mkdir  /mnt/temp/www/apps/#{application}/shared/galleries"
